  ...
  return (
    <div className="min-h-[100dvh] bg-white">
      ...
      <div className="relative bg-[#1a1a1a] overflow-hidden" style={{ height: 'clamp(300px, 50vw, 560px)' }}>
        ...
        <button
          onClick={() => navigate('/blog')}
          className="absolute top-6 left-6 inline-flex items-center gap-2 px-5 py-2.5 bg-white/10 backdrop-blur-sm border border-white/20 text-white text-xs font-black uppercase tracking-widest hover:bg-primary-500 hover:text-[#1a1a1a] hover:border-[#C8D400] transition-all duration-300"
          style={{ borderRadius: 0 }}
        >
          <i className="ri-arrow-left-line"></i>
          Blog
