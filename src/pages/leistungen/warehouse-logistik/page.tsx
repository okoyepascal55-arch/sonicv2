...
export default function WarehouseLogistikPage() {
 ...
 {/* Hero */}
 <div ref={heroRef}>
 <section className="relative min-h-[480px] md:min-h-[520px] flex flex-col justify-end overflow-hidden bg-foreground-950"style={{ paddingTop: '80px', paddingBottom: '60px' }}>
 <img
 src={heroImage}
 ...
 <h2 className="text-3xl md:text-5xl font-black text-foreground-950 leading-tight mb-2">
 ...
 <h3 className="text-lg md:text-xl font-black text-white mb-1">{WAREHOUSE_ITEMS[activeItem].title}</h3>
