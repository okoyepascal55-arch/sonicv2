...
const SOLUTIONS = [
  { num: '01', title: '(Kampagnen-)Konzeption', desc: 'Wir arbeiten heraus, wofür deine Marke steht und wie begeisternder Content aussehen könnte. From scratch oder adaptiert von deiner globalen Strategie.', tags: ['Strategie', 'Konzept', 'Kampagne'], fallback: 'https://readdy.ai/api/search-image?query=carved%20wooden%20lightbulb%20idea%20concept%20icon%20made%20from%20solid%20dark%20walnut%20wood%20three%20dimensional%20relief%20carving%20natural%20wood%20grain%20texture%20warm%20rich%20brown%20color%20simple%20minimalist%20handcrafted%20artisan%20quality%20on%20clean%20white%20background%20top%20view%20product%20photography%20studio%20lighting&width=112&height=112&seq=wood-kreation-sol-bulb-01&orientation=squarish' },
  { num: '02', title: 'Content Creation & Design', desc: 'Wir erstellen die Vorlagen für die Realisierung: Gestaltung plus Briefings / Texte / Scripts. Für Print / Packaging / POS, Digital / Shop, Social / Video.', tags: ['Design', 'Print', 'Digital'], fallback: 'https://readdy.ai/api/search-image?query=carved%20wooden%20paintbrush%20palette%20design%20creative%20icon%20made%20from%20solid%20dark%20walnut%20wood%20three%20dimensional%20relief%20carving%20natural%20wood%20grain%20texture%20warm%20rich%20brown%20color%20simple%20minimalist%20handcrafted%20artisan%20quality%20on%20clean%20white%20background%20top%20view%20product%20photography%20studio%20lighting&width=112&height=112&seq=wood-kreation-sol-palette-02&orientation=squarish' },
  { num: '03', title: 'Foto- & Video-Produktion', desc: 'Produktfotos und -filme, 3D / CGI / AI, Social Clips, Lifestyle-Shots, Event-Dokus, Imagefilme — in eigenen Studios und on Location.', tags: ['Foto', 'Video', 'CGI'], fallback: 'https://readdy.ai/api/search-image?query=carved%20wooden%20camera%20photography%20video%20production%20icon%20made%20from%20solid%20dark%20walnut%20wood%20three%20dimensional%20relief%20carving%20natural%20wood%20grain%20texture%20warm%20rich%20brown%20color%20simple%20minimalist%20handcrafted%20artisan%20quality%20on%20clean%20white%20background%20top%20view%20product%20photography%20studio%20lighting&width=112&height=112&seq=wood-kreation-sol-camera-03&orientation=squarish' },
  { num: '04', title: 'Asset-Produktion', desc: 'Post Production, Reinzeichnungen, Druck, Möbel- und Messebau, Content einpflegen / ausspielen.', tags: ['Post-Pro', 'Druck', 'Rollout'], fallback: 'https://readdy.ai/api/search-image?query=carved%20wooden%20document%20file%20copy%20asset%20production%20icon%20made%20from%20solid%20dark%20walnut%20wood%20three%20dimensional%20relief%20carving%20natural%20wood%20grain%20texture%20warm%20rich%20brown%20color%20simple%20minimalist%20handcrafted%20artisan%20quality%20on%20clean%20white%20background%20top%20view%20product%20photography%20studio%20lighting&width=112&height=112&seq=wood-kreation-sol-file-04&orientation=squarish' },
];
...
export default function KreationContentPage() {
  ...
  useSEO({ title: 'Kreation & Content | Sonic Group — Inhouse Foto, Video & CGI DACH', description: 'Kreation & Content von Sonic Group: Inhouse Foto- und Videoproduktion, CGI & 3D, Social Content und POS-Design für Marken im DACH-Raum. Alles aus einer Hand.', keywords: 'Content Produktion DACH, Inhouse Studio, CGI 3D Produktion, POS Design, Social Content Agentur', canonical: 'https://sonic-group.de/leistungen/kreation-content', ogTitle: 'Kreation & Content — Sonic Group DACH', ogDescription: 'Inhouse Foto, Video, CGI & POS-Design für Marken im DACH-Raum.' });
    ...
    <div id="kreation-page" className="min-h-[100dvh] overflow-x-hidden bg-white">
      ...
      <div ref={heroRef}>
        <section className="relative w-full overflow-hidden bg-white pb-0" style={{ paddingTop: 'clamp(100px, 9vw, 130px)' }}>
          ...
          <div className="relative z-10 w-full sonic-container px-6 text-center">
            ...
            <KreationHeroStats />
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12"><a href={`mailto:${CONTACT_EMAIL}?subject=Kreation%20Content%20Beratung`} className="inline-flex items-center gap-2 bg-foreground-950 text-background-50 px-7 py-3 font-black text-sm hover:bg-primary-500 hover:text-foreground-950 transition-colors"><i className="ri-calendar-line" />{tCtaBtn}</a><a href="/leistungen/video" className="inline-flex items-center gap-2 border-2 border-foreground-950/12 text-foreground-950/60 px-6 py-3 font-black text-sm hover:border-foreground-950 hover:text-foreground-950 transition-colors">Live Video<i className="ri-arrow-right-line" /></a></div>
          </div>
          <Carousel3DReference />
        </section>
      </div>
      ...
      <section id="loesung" className="sonic-section-lg px-4 md:px-6 relative overflow-hidden bg-white">
        ...
        <div ref={solutionRef} className="sonic-container relative" style={{ opacity: solutionVisible ? 1 : 0, transform: solutionVisible ? 'translateY(0)' : 'translateY(32px)', transition: 'opacity 0.7s ease, transform 0.7s ease' }}>
          <div className="mb-10"><div className="flex items-center gap-3 mb-5"><span className="w-7 h-0.5 bg-primary-500" /><span className="text-[11px] font-black uppercase tracking-[0.24em]" style={{ color: 'oklch(0.55 0.08 115)' }}>Die Lösung</span></div><h2 className="sonic-h2 text-foreground-950 uppercase mb-3">{tSolutionHeading}</h2><p className="text-foreground-950/50 text-base max-w-2xl">{tSolutionSub}</p></div>
