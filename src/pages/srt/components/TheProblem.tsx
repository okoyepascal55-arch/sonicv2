...
const PROBLEM_DATA = [
  { num: '01', icon: 'ri-database-2-line', title: 'Getrennte Datensilos', headline: 'Daten liegen überall — nur nicht zusammen.', body: 'Die Realität im Retail: WaWi-Daten hier, Kampagnendaten dort, Einsatzplanung in einem Drittanbieter-Tool. Jede Abteilung pflegt ihre eigene Wahrheit. Ein ganzheitliches Bild der Performance entsteht — wenn überhaupt — nur durch aufwendige manuelle Zusammenführung.', impact: 'Ergebnis: Wertvolle Zeit geht verloren. Entscheidungen basieren auf Datenschnipseln statt auf der vollständigen Realität.', tags: ['WaWi', 'Marketing', 'Silos', 'Manuell'], fallbackWoodIcon: svgGradient('#3a3320', '#17160f') },
  { num: '02', icon: 'ri-eye-off-line', title: 'Keine Dashboards', headline: 'Was du nicht siehst, kannst du nicht steuern.', body: 'Ohne eine gemeinsame Datenbasis ist es schlicht unmöglich, aussagekräftige KPIs zu definieren und live zu monitoren. Kampagnen-Performance wird erst nach Wochen sichtbar — oft zu spät, um noch einzugreifen. Führungskräfte treffen Entscheidungen im Blindflug.', impact: 'Ergebnis: Fehlgeleitete Ressourcen, verpasste Optimierungsfenster, frustrierte Stakeholder.', tags: ['KPI', 'Monitoring', 'Dashboard', 'Echtzeit'], fallbackWoodIcon: svgGradient('#20323a', '#0f1517') },
  { num: '03', icon: 'ri-time-line', title: 'Verspätete Erkenntnisse', headline: 'Wer zu spät kommt, verliert den Marktanteil.', body: 'Manuelle Auswertungen, Excel-Konsolidierungen, wöchentliche Meetings nur um Datenstände zu berichten — das kostet Zeit, die am Markt fehlt. Wenn eine Kampagne schlecht läuft, erfährt das Management es erst Tage oder Wochen später. Schnelle Nachjustierungen sind dann kaum noch möglich.', impact: 'Ergebnis: Reaktives statt proaktives Management. Wettbewerber, die schneller sehen, agieren schneller.', tags: ['Insights', 'Echtzeit', 'Verzug', 'Reaktiv'], fallbackWoodIcon: svgGradient('#2b3a20', '#12160e') },
];
