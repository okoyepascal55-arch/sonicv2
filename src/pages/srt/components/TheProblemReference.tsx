...
const PROBLEMS = [
  { num: '01', icon: 'ri-database-2-line', title: 'Getrennte Datensilos', headline: 'Daten liegen überall — nur nicht zusammen.', body: 'Die Realität im Retail: WaWi-Daten hier, Kampagnendaten dort, Einsatzplanung in einem Drittanbieter-Tool. Jede Abteilung pflegt ihre eigene Wahrheit. Ein ganzheitliches Bild der Performance entsteht — wenn überhaupt — nur durch aufwendige manuelle Zusammenführung.', impact: 'Ergebnis: Wertvolle Zeit geht verloren. Entscheidungen basieren auf Datenschnipseln statt auf der vollständigen Realität.', tags: ['WaWi', 'Marketing', 'Silos', 'Manuell'], woodIcon: 'https://readdy.ai/api/search-image?query=carved%20wooden%20separated%20fragmented%20database%20cylinder%20storage%20units%20icon%20made%20from%20solid%20dark%20walnut%20wood%20three%20dimensional%20relief%20carving%20natural%20wood%20grain%20texture%20warm%20rich%20brown%20color%20simple%20minimalist%20isolated%20data%20sources%20symbol%20handcrafted%20artisan%20quality%20on%20clean%20white%20background%20top%20view%20product%20photography%20studio%20lighting&width=112&height=112&seq=wood-db-srt-problem-1&orientation=squarish' },
  { num: '02', icon: 'ri-eye-off-line', title: 'Keine Dashboards', headline: 'Was du nicht siehst, kannst du nicht steuern.', body: 'Ohne eine gemeinsame Datenbasis ist es schlicht unmöglich, aussagekräftige KPIs zu definieren und live zu monitoren. Kampagnen-Performance wird erst nach Wochen sichtbar — oft zu spät, um noch einzugreifen. Führungskräfte treffen Entscheidungen im Blindflug.', impact: 'Ergebnis: Fehlgeleitete Ressourcen, verpasste Optimierungsfenster, frustrierte Stakeholder.', tags: ['KPI', 'Monitoring', 'Dashboard', 'Echtzeit'], woodIcon: 'https://readdy.ai/api/search-image?query=carved%20wooden%20monitor%20computer%20screen%20dashboard%20display%20icon%20made%20from%20solid%20dark%20walnut%20wood%20three%20dimensional%20relief%20carving%20natural%20wood%20grain%20texture%20warm%20rich%20brown%20color%20simple%20minimalist%20empty%20screen%20symbol%20handcrafted%20artisan%20quality%20on%20clean%20white%20background%20top%20view%20product%20photography%20studio%20lighting&width=112&height=112&seq=wood-screen-srt-problem-2&orientation=squarish' },
  { num: '03', icon: 'ri-time-line', title: 'Verspätete Erkenntnisse', headline: 'Wer zu spät kommt, verliert den Marktanteil.', body: 'Manuelle Auswertungen, Excel-Konsolidierungen, wöchentliche Meetings nur um Datenstände zu berichten — das kostet Zeit, die am Markt fehlt. Wenn eine Kampagne schlecht läuft, erfährt das Management es erst Tage oder Wochen später. Schnelle Nachjustierungen sind dann kaum noch möglich.', impact: 'Ergebnis: Reaktives statt proaktives Management. Wettbewerber, die schneller sehen, agieren schneller.', tags: ['Insights', 'Echtzeit', 'Verzug', 'Reaktiv'], woodIcon: 'https://readdy.ai/api/search-image?query=carved%20wooden%20clock%20hourglass%20time%20delay%20waiting%20icon%20made%20from%20solid%20dark%20walnut%20wood%20three%20dimensional%20relief%20carving%20natural%20wood%20grain%20texture%20warm%20rich%20brown%20color%20simple%20minimalist%20time%20passing%20symbol%20handcrafted%20artisan%20quality%20on%20clean%20white%20background%20top%20view%20product%20photography%20studio%20lighting&width=112&height=112&seq=wood-clock-srt-problem-3&orientation=squarish' },
];
              ...
              <div key={problem.num} className="relative border-t border-foreground-950/10">
                <button type="button" className="w-full text-left px-6 md:px-8 py-8 cursor-pointer transition-colors hover:bg-[#FAFDF5]" onClick={() => setOpen(isOpen ? null : index)} aria-expanded={isOpen}>
                  <div className="grid md:grid-cols-[80px_1fr_auto] gap-4 md:gap-8 items-start">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2"><span className="flex w-8 h-8 items-center justify-center border overflow-hidden" style={{ borderColor: 'oklch(0.81 0.19 115 / 0.3)', background: 'transparent' }}><img src={getWoodIcon(index)} alt={problem.title} className="w-full h-full object-cover" loading="lazy" /></span><span className="text-[10px] font-black uppercase tracking-widest text-foreground-500">{problem.title}</span></div>
