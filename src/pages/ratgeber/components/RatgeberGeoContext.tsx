            ...
            <div className="border border-foreground-950/10 bg-white p-5" style={{ borderRadius: 0 }}>
              ...
              <div className="flex flex-wrap gap-2">
                {data.cities.map((city) => (
                  <span key={city} className="px-3 py-1 bg-[#C8D400]/10 text-foreground-950/70 text-xs font-semibold" style={{ borderRadius: 0 }}>
                    {city}
                  </span>
                ))}
              </div>
            ...
            <div className="border border-foreground-950/10 bg-white p-5" style={{ borderRadius: 0 }}>
              ...
              <div className="flex flex-wrap gap-2">
                {data.regions.map((region) => (
                  <span key={region} className="px-3 py-1 bg-[#C8D400]/10 text-foreground-950/70 text-xs font-semibold" style={{ borderRadius: 0 }}>
                    {region}
                  </span>
                ))}
              </div>
            ...
            <div className="border border-foreground-950/10 bg-white p-5" style={{ borderRadius: 0 }}>
              ...
              <div className="flex flex-wrap gap-2">
                {data.countries.map((country) => (
                  <span key={country} className="px-3 py-1 bg-[#C8D400]/10 text-foreground-950/70 text-xs font-semibold" style={{ borderRadius: 0 }}>
                    {country}
                  </span>
                ))}
              </div>
