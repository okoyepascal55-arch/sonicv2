...
export default function FloatingBadge({ icon, text, variant = 'lime', className = '' }: FloatingBadgeProps) {
  ...
  return (
    <div
      className={`absolute flex items-center gap-1.5 px-3 py-1.5 max-w-[85vw] text-[10px] sm:text-xs font-black uppercase tracking-wide whitespace-normal sm:whitespace-nowrap ${className}`}
      style={{
