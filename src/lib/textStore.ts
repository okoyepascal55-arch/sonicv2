...
export const DEFAULT_TEXT_SECTIONS: TextSection[] = [
  ...
  /* ════════════════════════════════════════════ SONIC REELS ════════════════════ */
  {
    ...
    entries: [
      { id: 'reels-splash-sub', label: 'Splash Subtitle', description: 'Hero subtitle', type: 'label', value: '2007 — Heute' },
      ...
      { id: 'reels-page-subtitle', label: 'Page Subtitle', description: 'Page subtitle', type: 'paragraph', value: 'Fast zwei Jahrzehnte Retail-Aktivierung — erzählt in den Momenten, die uns geprägt haben.' },
      ...
      { id: 'reels-era-1-tagline', label: 'Era 1 Tagline', description: 'Der Anfang', type: 'heading', value: 'Der Anfang' },
      { id: 'reels-era-2-label', label: 'Era 2 — 2015–2019 Label', description: 'Era label', type: 'label', value: '2015–2019' },
      { id: 'reels-era-2-tagline', label: 'Era 2 Tagline', description: 'Der Aufstieg', type: 'heading', value: 'Der Aufstieg' },
      { id: 'reels-era-3-label', label: 'Era 3 — 2019–2022 Label', description: 'Era label', type: 'label', value: '2019–2022' },
      { id: 'reels-era-3-tagline', label: 'Era 3 Tagline', description: 'Die Stärke', type: 'heading', value: 'Die Stärke' },
      { id: 'reels-era-4-label', label: 'Era 4 — 2022–2023 Label', description: 'Era label', type: 'label', value: '2022–2023' },
      { id: 'reels-era-4-tagline', label: 'Era 4 Tagline', description: 'Die Beschleunigung', type: 'heading', value: 'Die Beschleunigung' },
      { id: 'reels-era-5-label', label: 'Era 5 — 2024 Label', description: 'Era label', type: 'label', value: '2024' },
      { id: 'reels-era-5-tagline', label: 'Era 5 Tagline', description: 'Die Kante', type: 'heading', value: 'Die Kante' },
      { id: 'reels-era-6-label', label: 'Era 6 — 2025 Label', description: 'Era label', type: 'label', value: '2025' },
      { id: 'reels-era-6-tagline', label: 'Era 6 Tagline', description: 'Der Gipfel', type: 'heading', value: 'Der Gipfel' },
      { id: 'reels-era-7-label', label: 'Era 7 — 2026 Label', description: 'Era label', type: 'label', value: '2026' },
      { id: 'reels-era-7-tagline', label: 'Era 7 Tagline', description: 'Der Horizont', type: 'heading', value: 'Der Horizont' },
      ...
      { id: 'reels-era-2-quote', label: 'Era 2 Quote', description: '2015–2019 quote', type: 'quote', value: 'Samsung kam über Nacht, und zweihundert Spezialistinnen und Spezialisten lasteten auf unseren Schultern. Also haben wir die Systeme gebaut, um sie zu tragen — Training, Zertifizierung, Echtzeit-Kommunikation.' },
      { id: 'reels-era-2-attribution', label: 'Era 2 Attribution', description: '2015–2019 attribution', type: 'label', value: 'Jo Heitkämper · Mitgründer, 2015' },
      { id: 'reels-era-2-caption', label: 'Era 2 Caption', description: '2015–2019 photo caption', type: 'caption', value: 'Zweihundert Spezialisten. Ein Rollout.' },
      { id: 'reels-era-3-quote', label: 'Era 3 Quote', description: '2019–2022 quote', type: 'quote', value: 'Zweiundsiebzig Stunden, um das gesamte Konzept neu aufzubauen. Als die Geschäfte wieder öffneten, standen wir bereits drin — und wir haben keinen einzigen Kunden verloren.' },
      { id: 'reels-era-3-attribution', label: 'Era 3 Attribution', description: '2019–2022 attribution', type: 'label', value: 'Lucas Kreiten · Geschäftsführer, 2020' },
      { id: 'reels-era-3-caption', label: 'Era 3 Caption', description: '2019–2022 photo caption', type: 'caption', value: 'Geschlossene Türen. Offenes Konzept.' },
      ...
      { id: 'reels-era-6-attribution', label: 'Era 6 Attribution', description: '2025 attribution', type: 'label', value: 'Jo Heitkämper · Mitgründer, 2025' },
